...
namespace RPGFramework.Core.DI
{
    public class DIContainer
    {
        ...
        private readonly Dictionary<Type, string>          m_Modules;
        ...
        public DIContainer()
        {
            ...
            m_Modules                = new Dictionary<Type, string>();
        ...
        public string GetModuleName<TInterface>()
        {
            return m_Modules[typeof(TInterface)];
        }
        ...
        public void BindModule<TInterface, TConcrete>() where TInterface : IModule where TConcrete : TInterface
        {
            m_Modules[typeof(TInterface)] = typeof(TConcrete).Name;
